...
if($childrenPages or $parentPage){ ?>
    <div class="sidebar">
    <h2 class="sidebar-title"><a href="<?php echo get_permalink($parentPage)?>"><?php echo get_the_title($parentPage)?></a></h2>
...
if($parentPage){ ?>
    <div class="breadcrumb-btns">
        <div class="breadcrumb-1">
            <a href="#"><i class="fa fa-home" aria-hidden="true"></i> Back to <a href = "<?php  echo get_permalink($parentPage) ?>"></a>
        </div>
