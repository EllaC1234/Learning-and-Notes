# Linked list
# HEAD NODE -> NODE -> NODE -> NODE -> None (terminates list)
# Each node stores its data and the address of the next node in the sequence.
# Circular linked lists are implemented similarly, but the last node points back to the head node.
